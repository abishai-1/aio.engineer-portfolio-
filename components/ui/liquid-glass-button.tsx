...
/* ─── Liquid Glass Button ───────────────────────────────────
   A transparent glass-morphism button with SVG-distorted
   backdrop filter, complex inset shadows, and liquid depth.
   ──────────────────────────────────────────────────────── */
...
export function LiquidButton({
  ...
  return (
    ...
    >
      ...
      {/* Inline SVG filter — renders once per button instance */}
      <GlassFilter />
    </Comp>
  );
}
